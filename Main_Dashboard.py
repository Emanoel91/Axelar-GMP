...
st.markdown(
    ...
    <div style="margin-top: 20px; margin-bottom: 20px; font-size: 16px;">
        <div style="display: flex; align-items: center; gap: 10px; margin-bottom: 10px;">
            ...
            <span>Dashboard Reference (Some of the code and charts were modified and rewritten): <a href="https://flipsidecrypto.xyz/hess/axelar-gmp-VV7aX3" target="_blank">https://flipsidecrypto.xyz/hess/axelar-gmp-VV7aX3/</a></span>
        </div>
        <div style="display: flex; align-items: center; gap: 10px;">
